...
<header>
  ...
  <div id="contact" class="contact">
    ...
    <div class="contact-item">
      ...
      <i class="fa fa-envelope aria-hidden="true></i> keminglu at usc.edu
      
    </div>
    
    <div class="contact-item">
      
      <i class="fa fa-phone-square aria-hidden="true></i> +86-156-5267-1629
      
    </div>
    
    <div class="contact-item">
      
      <a href="https://crispgm.github.io/resume/resume.html" target="_blank" rel="noopener">
      
      <i class="fa fa-globe aria-hidden="true></i> lukeming-tsinghua.github.io
...
<section id="introduction">
  ...
  <div class="section-content">
	...
	Hi, I am Keming |kəmiːŋ| Lu |luː| from China. I am a graduate student in University of Southern California. And I am working on M.S. in Analytics in ISE, Viterbi, USC. I obtained my bachelor degree in Tsinghua Univerisity, which majors in Automation and minors in Statistics. As for research interests, I am particularly interested in how to use external information, for example knowledge graph and common senses, to enhance performances of information extraction algorithms on open domain situations. Besides, I am also interested in neural network explanation. During my undergraduate, I was working on building a large scale medical relation extraction framework, which involves distant supervision, relation extraction and knowledge graph. I also have experienced with bioinformatics, mainly focusing on synthetic biology and single cell transcriptome analysis.
      </div>
    </div>
...
<footer>
Made with <i class="fa fa-heart aria-hidden="true></i> by <a href="https://github.com/crispgm/resume" target="_blank" rel="noopener">crispgm resume</a> <span class="print">( <a href="javascript:window.print()">PDF</a> )</span>
footer>
